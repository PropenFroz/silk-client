...
const SideBarKaryawan = () => {
  ...
  return (
    <div className={`app`}>
      <CDBSidebar textColor="#1C1C1C" backgroundColor="#FFFFFF">
        ...
        <CDBSidebarContent className="sidebar-content">
          ...
          <CDBSidebarMenu>
            ...
            <NavLink exact to="/laporan-transaksi-siswa" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="fa-regular fa-clipboard" className="sidebar-menu-item">
                Transaksi Siswa
              </CDBSidebarMenuItem>
            </NavLink>
