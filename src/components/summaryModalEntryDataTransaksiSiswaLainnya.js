...
import sendEntryData from "../service/entryDataTransaksiSiswaLainnyaService";
...
function SummaryModal({ formData, selectedSiswa, show, onHide, onSuccess }) {
  ...
  return (
    <Modal show={show} onHide={onHide}>
      ...
      <Modal.Body>
        <p>
          <strong>Jenis Pembayaran:</strong> Lainnya
        </p>
        <p>
        ...
        <p>
          <strong>Uang Buku:</strong> {formatRupiah(formData.uangBuku)}
        </p>
        <p>
